...
- **Branch protection** — enforced by Repository Rulesets defined in `.github/rulesets/` and applied with `bash scripts/apply-rulesets.sh`. See [`BRANCH-PROTECTION.md`](BRANCH-PROTECTION.md) for the full matrix of rules and the negative-path tests.
